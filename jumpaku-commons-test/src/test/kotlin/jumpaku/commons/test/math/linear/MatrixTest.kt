...
class MatrixTest {
    ...
    fun testToDoubleArrays() {
        ...
        val e_id44 = arrayOf(
            Vector.of(4, mapOf(0 to 1.0)),
            Vector.of(4, mapOf(1 to 1.0)),
            Vector.of(4, mapOf(2 to 1.0)),
            Vector.of(4, mapOf(3 to 1.0)))
        ...
        val e_di44 = arrayOf(
            Vector.of(4, mapOf(0 to -0.5)),
            Vector.of(4, mapOf(1 to 2.0)),
            Vector.of(4, mapOf(2 to 1.0)),
            Vector.of(4, mapOf(3 to 3.0)))
            .map { it.toDoubleArray() }
        ...
        val e_sp44 = arrayOf(
            Vector.of(listOf(3.0, 1.0, 2.0, 0.0)),
            Vector.of(listOf(2.0, 4.0, 2.0, 2.0)),
            Vector.of(listOf(1.0, -4.0, 0.0, 1.0)))
            .map { it.toDoubleArray() }
